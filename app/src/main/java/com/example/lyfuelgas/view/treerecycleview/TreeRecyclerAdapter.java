package com.example.lyfuelgas.view.treerecycleview;
...
import com.example.lyfuelgas.view.treerecycleview.manager.ItemManageImpl;
        ...
        if (!view.hasOnClickListeners()) {
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    int layoutPosition = holder.getLayoutPosition()-getHeaderCount();
                    //获得处理后的position
                    ...
                    if (item instanceof TreeItemGroup && type != TreeRecyclerType.SHOW_ALL) {
                        ...
                        getItemManager().replaceItem(layoutPosition,treeItemGroup);
                    }
